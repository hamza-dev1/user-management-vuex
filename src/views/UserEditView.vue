<template>
	<h1 class="text-2xl mb-4">Update <span class="text-green-700 underline underline-offset-2">{{ state.name }}</span></h1>
  <div class="flex">
    <div
      class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 w-11/12 sm:w-5/6 md:w-4/6 lg:w-3/6 mx-auto"
    >
      <form>
        <div class="mb-6">
          <label
