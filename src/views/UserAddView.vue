<template>
  <div class="mx-auto bg-white md:w-5/6 lg:w-4/6 xl:w-3/6">
    <h1 class="text-2xl mb-3">Add user</h1>
    <div
      class="p-5 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
    >
      <form @submit.prevent="addUser">
        <div :class="{ error: hasError('name') }" class="mb-6">
          ...
          <input
            ...
            v-model="user.name"
          />
          <span class="text-red-700 dark:text-red-500" v-if="hasError('name')"
        ...
        <div :class="{ error: hasError('email') }" class="mb-6">
          ...
          <input
            ...
            v-model="user.email"
          />
          <span class="text-red-700 dark:text-red-500" v-if="hasError('email')"
            >Please provide a value</span
          >
        </div>
        <div :class="{ error: hasError('phone') }" class="mb-6">
          ...
          <input
            ...
            v-model="user.phone"
          />
          <span class="text-red-700 dark:text-red-500" v-if="hasError('phone')"
            >Please provide a value</span
          >
        </div>
        <div :class="{ error: hasError('about') }" class="mb-6">
          ...
          <textarea
            ...
            v-model="user.about"
          ></textarea>
          <span class="text-red-700 dark:text-red-500" v-if="hasError('about')"
            >Please provide a value</span
          >
        </div>
...
export default {
  ...
  setup() {
    ...
    const fieldInitalState = {
      ...
      }.png`), // generate number between 1 and 5 (because i have 5 images)
    };
    const user = reactive({
      ...fieldInitalState,
    });
